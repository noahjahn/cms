...
# so this replaces any ${PORT} defined in the default.conf.template file 
# and creates a conf for nginx to read at runtime
...
until pg_isready --quiet --host=$DB_SERVER --port=$DB_PORT --dbname=$DB_DATABASE --username=$DB_USER
do
